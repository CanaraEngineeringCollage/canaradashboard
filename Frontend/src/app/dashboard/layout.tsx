  ...
  return (
    <SidebarProvider defaultOpen>
      <Sidebar collapsible="icon" variant="sidebar" side="left" className="border-r">
        <SidebarHeader className="h-16 flex items-center justify-between p-4 ms-[-45px]">
          <div className="flex items-center   ">
            ...
            width={100}
             src={logoImg} 
             className='w-[200px] h-auto text-sidebar-foreground px-2 py-4 ' alt="canara" />
          </div>
        </SidebarHeader>
        <SidebarContent className="py-8 mt-3 px-3">
          <SidebarNavItems />
        </SidebarContent>
